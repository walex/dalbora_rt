...
//std::unique_ptr<RHI_PIPELINE_LAYOUT> dx12_pipeline_layout_create(const RHI_PIPELINE_LAYOUT_DESC& desc) {
//	
//	
//	std::vector<D3D12_DESCRIPTOR_RANGE> descriptor_ranges;
//	std::vector<D3D12_DESCRIPTOR_RANGE> descriptor_ranges_sampler;
//
...
//		}
//		
//		D3D12_DESCRIPTOR_RANGE* range = (range_type == D3D12_DESCRIPTOR_RANGE_TYPE_SAMPLER)
...
//
//		D3D12_ROOT_PARAMETER& root_parameter = root_params.emplace_back();
...
//	rootDesc.NumParameters = static_cast<UINT>(root_params.size());
//	rootDesc.pParameters = root_params.data();
