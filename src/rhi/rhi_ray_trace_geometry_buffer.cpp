...
RhiView RhiRayTraceGeometrydBufferInstances::new_view(const RhiDevice& device, RHI_MEMORY_DESCRIPTOR_SLOT* memory_descriptor_slot) {
	...
	return RhiBuffer::new_view(device, shader_view_type_bvh_buffer, memory_descriptor_slot);
}
