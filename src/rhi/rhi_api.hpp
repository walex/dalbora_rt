#ifndef __rhi_api_hpp__
#define __rhi_api_hpp__
...
inline RHI_BUFFER*(*rhi_rt_bvh_build_geometry_instances)(const RHI_RT_BVH_GEOMETRY_DESC* const desc);
inline void (*rhi_command_buffer_ray_trace)(RHI_COMMAND_BUFFER* const command_buffer,
	RHI_TEXTURE_2D* const render_target, const RHI_SBT_TABLE* const sbt);
