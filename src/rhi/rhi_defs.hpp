...
enum resource_type
{
	resource_type_texture_read_only = 1,
	resource_type_texture_writable = 2,
	resource_type_buffer_writable = 3,
	resource_type_buffer_read_only = 4,
	resource_type_constant_buffer = 5,
	resource_type_generic_rw_buffer = 6,
	resource_type_sampler = 7,
	resource_type_render_target = 8,
	resource_type_depth_stencil_target = 9
};
...
enum buffer_type {
	...
	buffer_type_undef = 0,
	buffer_type_raw = 1,
	buffer_type_image_1d = 2,
	buffer_type_image_2d = 3,
...
#define DEFINE_SETTER(var_name) void set_##var_name(auto value) {var_name = value;}
#define DEFINE_GETTER(var_name) auto get_##var_name() const {return var_name;}
