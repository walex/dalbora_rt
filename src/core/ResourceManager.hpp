...
public:
	...
	RhiMemoryDescriptor* get_read_only_buffer_descriptor_slot();
	RhiMemoryDescriptor* get_constant_buffer_descriptor_slot();
	RhiMemoryDescriptor* get_rw_buffer_descriptor_slot();
